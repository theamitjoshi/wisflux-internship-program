...
1. Why do we use functions in JavaScript?
  ...
  * Instead, we can just create a function once which defines the logic of squaring a number and use that function multiple time.<br></br>
2. What is Function Invocation?
   * A Function is Invoked when it's name is written with a parenthesis "()" written in front of it. <br></br>
3. Does a function behave like an object in Javascript? Prove it by an example.
   ...
   * It also has some properties attached to it since essentially it IS an object. They are :- `name` and `length`  <br></br>
4. What are Events in Javascript?
   ...
   * EventListeners are used for that purpose.  <br></br>
5. What is a string?
   * A string is an array of characters.  <br></br>
6. What is an array? Is it static or dynamic in Javascript?
   * An array is an ordered collection of elements.
   * JavaScript arrays are dynamic in nature. 
   * This means that there is no pre-defined length of the array.
   * The size of the array is automatically increased / decreased based on the insertion / deletion of elements from it.   <br></br>
